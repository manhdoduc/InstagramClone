    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppUser_UserName = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AppUser_Email = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FullNameSearch = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Bio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvatarUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true),
                    IsPrivateAccount = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AppUser_Email",
                table: "Users",
                column: "AppUser_Email");

            migrationBuilder.CreateIndex(
                name: "IX_Users_AppUser_UserName",
                table: "Users",
                column: "AppUser_UserName");
